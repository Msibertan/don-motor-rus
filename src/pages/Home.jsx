...
const guarantees = [
  ...
  ['04', 'Срок 25–45 дней', 'Отлаженная логистика через Польшу, Литву и Латвию.'],
]

const faq = [
  { q: 'Сколько занимает пригон?', a: 'В среднем 25–45 дней от заключения договора до выдачи. Срок зависит от страны, очередей на границе и загрузки таможни. На каждом этапе вы видите статус.' },
      ...
      <section className="section">
        <div className="container">
          <Reveal>
            <div className="manifesto-grid">
              ...
              <div className="manifesto-aside">
                <p>
                  Девять лет возим премиальные автомобили из Европы. Подбор на
                  аукционах, проверка до оплаты, прозрачная логистика и
                  официальная растаможка.
                </p>
                <p>
          ...
          <div className="hero__metrics" style={{ marginTop: 'clamp(48px,7vw,90px)' }}>
            ...
            <Counter value={9} suffix=" лет" label="на рынке европейского авто" />
            <Counter value={32} suffix=" дня" label="средний срок поставки" />
