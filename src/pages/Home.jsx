...
const guarantees = [
  ...
  ['03', 'Полностью официально', 'Таможенная очистка, утильсбор и учёт в ГИБДД. Документы на руки.'],
  ['04', 'Срок 7–14 дней', 'Отлаженная логистика через Польшу, Литву и Латвию.'],
]

const faq = [
  { q: 'Сколько занимает пригон?', a: 'В среднем 7–14 дней от заключения договора до выдачи. Срок зависит от страны, очередей на границе и загрузки таможни. На каждом этапе вы видите статус.' },
  { q: 'Что входит в стоимость под ключ?', a: 'Стоимость автомобиля в Европе, доставка, таможенная очистка и утилизационный сбор, постановка на учёт и услуга компании. Всё фиксируется в договоре заранее.' },
  { q: 'Можно заказать автомобиль, которого нет в каталоге?', a: 'Да. Опишите марку, бюджет и пожелания — мы найдём варианты у владельцев и дилеров в Европе и пришлём подборку с реальными ценами и фотографиями.' },
