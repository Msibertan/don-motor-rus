...
const steps = [
  {
    ...
    text: 'Обсуждаем бюджет, марку и задачи. Подбираем варианты у владельцев и дилеров в Германии, Польше, Литве и Латвии. Присылаем подборку с реальными ценами и фотографиями.',
