...
const steps = [
  ...
  },
  {
    ...
    text: 'Подписываем договор, фиксируя итоговую стоимость под ключ. Выкупаем автомобиль напрямую у владельца, начинаем процесс таможенной очистки и отправляем его к вам автовозом.',
    tags: ['Договор', 'Выкуп у владельца', 'Автовоз'],
  },
  {
    img: 'proc-ship',
    title: 'Логистика до России',
    text: 'Транспортировка из Германии, прохождение границы и доставка в Россию по отлаженному маршруту. Вы видите статус и геопозицию на каждом этапе.',
    tags: ['Германия', 'Граница', 'Трекинг'],
  },
  {
    img: 'proc-customs',
    title: 'Таможенная очистка',
    text: 'Официальная таможенная очистка автомобиля, расчёт и оплата всех необходимых пошлин. Все процедуры проводятся легально, с выдачей полного пакета документов.',
    tags: ['Очистка', 'Пошлины', 'Официально'],
  },
  {
    img: 'proc-handover',
    title: 'Учёт и выдача',
