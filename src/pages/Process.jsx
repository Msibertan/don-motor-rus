...
const steps = [
  {
    ...
    text: 'Обсуждаем бюджет, марку и задачи. Подбираем варианты на аукционах и площадках Германии, Польши, Литвы и Латвии. Присылаем подборку с реальными ценами и фотографиями.',
  ...
  },
  {
    ...
    text: 'Фиксируем итоговую стоимость под ключ в договоре. Вы вносите оплату, мы выкупаем автомобиль у продавца и оформляем экспортные документы.',
    tags: ['Договор', 'Фикс цены', 'Выкуп'],
  },
  {
    img: 'proc-ship',
  ...
  },
  {
    img: 'proc-customs',
    title: 'Растаможка',
    text: 'Расчёт и оплата таможенных платежей, утилизационного сбора, оформление ЭПТС и СБКТС. Полностью официально, с пакетом документов на руки.',
    tags: ['ЭПТС', 'СБКТС', 'Утильсбор'],
  },
  {
    img: 'proc-handover',
    title: 'Учёт и выдача',
